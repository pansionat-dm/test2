<?
global $arLinkedBrandsFilter;
$linkedItems = $arParams["LINKED_ITEMS"];
$arLinkedBrandsFilter = array("ID" => $linkedItems);
...
<?if(!empty($linkedItems)):?>
	<?$APPLICATION->IncludeComponent(
		...
		array(
			...
			"FILTER_NAME" => "arLinkedBrandsFilter",
			...
			"ADDITIONAL_CSS_CLASS" => "brands",
			"RESIZE_TYPE" => "contain",
			"IMAGE_ASPECT_RATIO" => "3by2",
		),
		false
	);?>
<?endif?>
